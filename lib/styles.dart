...
class AppStyles {
  ...
  static TextStyle textStyleAddressHidden(
      {fontSize = AppFontSizes.small, fontWeight = FontWeight.w100}) {
    return TextStyle(
        fontFamily: 'OverpassMono',
        fontSize: fontSize,
        fontWeight: fontWeight,
  ...
  static TextStyle textStyleCurrencyAltHidden(
      {fontSize = AppFontSizes.small, fontWeight = FontWeight.w600}) {
    return TextStyle(
        fontFamily: 'NunitoSans',
        fontSize: fontSize,
        fontWeight: fontWeight,
  ...
  static TextStyle textStyleCurrencyPrimary60(BuildContext context, { fontWeight = FontWeight.w100}) {
    return TextStyle(
        fontFamily: 'NunitoSans',
        fontSize: AppFontSizes.small,
        fontWeight: fontWeight,
  ...
  // Text style for share card
  static TextStyle textStyleShare(BuildContext context) {
    return TextStyle(
        fontSize: 50,
        color: StateContainer.of(context).curTheme.text,
        fontFamily: 'OverpassMono',
  ...
  static TextStyle textStyleSharePrimary(BuildContext context) {
    return TextStyle(
        fontSize: 50,
        color: StateContainer.of(context).curTheme.primary,
        fontFamily: 'OverpassMono',
