...
class AppLocalization {
  ...
  String get welcomeText {
    return Intl.message(
        'Welcome to Libra. To begin you may create a new wallet or import an existing one.',
  ...
  String get sendAmountConfirm {
    return Intl.message('Send %1 LIBRA',
  ...
  String get shareLibra {
    return Intl.message('Share Libra',
        desc: 'settings_share', name: 'shareLibra');
  }

  String get shareLibraText {
    return Intl.message("Check out Libra! Libra's official mobile wallet!",
        desc: 'share_extra', name: 'shareLibraText');
  }
  ...
  String get logoutDetail {
    return Intl.message(
        'Logging out will remove your seed and all Libra-related data from this device. If your seed is not backed up, you will never be able to access your funds again',
  ...
  String get libraWallet {
    return Intl.message('Libra Wallet',
        desc: 'libra_wallet', name: 'libraWallet');
  }
  ...
  String get transferIntro {
    return Intl.message(
        'This process will transfer the funds from a paper wallet to your Libra wallet.\n\nTap the \'%1\' button to start.',
        desc: 'transfer_intro',
        name: 'transferIntro');
  }

  String get transferQrScanHint {
    return Intl.message('Scan a Libra \nseed or private key',
  ...
  String get transferNoFunds {
    return Intl.message('This seed does not have any LIBRA on it',
  ...
  String get transferConfirmInfo {
    return Intl.message(
        'A wallet with a balance of %1 LIBRA has been detected.\n',
  ...
  String get transferComplete {
    return Intl.message(
        '%1 LIBRA successfully transferred to your Libra Wallet.\n',
  ...
  String get unlockPin {
    return Intl.message('Enter PIN to Unlock Libra',
        desc: 'unlock_libra_pin', name: 'unlockPin');
  }

  String get unlockBiometrics {
    return Intl.message('Authenticate to Unlock Libra',
        desc: 'unlock_libra_bio', name: 'unlockBiometrics');
  }
  ...
  String get exampleCardIntro {
    return Intl.message(
        'Welcome to Libra. Once you receive LIBRA, transactions will show up like this:',
  ...
  String get exampleCardTo {
    return Intl.message('to a random avatar',
        desc: 'example_card_to', name: 'exampleCardTo');
  }

  String get exampleCardFrom {
    return Intl.message('from a random avatar',
  ...
  String get newAccountIntro {
    return Intl.message(
        'This is your new account. Once you receive LIBRA, transactions will show up like this:',
