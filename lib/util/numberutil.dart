...
class NumberUtil {
  final BigInt rawPerLibra = BigInt.from(1000000);
  ...
  /// Convert raw to libra and return as BigDecimal
  ///
  /// @param raw 1000000
  /// @return Decimal value 1.000000
  ///
  Decimal getRawAsUsableDecimal(String raw) {
    Decimal amount = Decimal.parse(raw.toString());
    Decimal result = amount / Decimal.parse(rawPerLibra.toString());
    return result;
  }
  ...
  String getAmountAsRaw(String amount) {
    ...
    Decimal rawDecimal = Decimal.parse(rawPerLibra.toString());
