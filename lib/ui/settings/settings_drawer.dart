...
import 'package:wallet/ui/accounts/accountdetails_sheet.dart';
import 'package:wallet/ui/accounts/accounts_sheet.dart';
import 'package:wallet/ui/widgets/app_simpledialog.dart';
...
import 'package:wallet/model/device_unlock_option.dart';
...
import 'package:wallet/ui/settings/backupseed_sheet.dart';
import 'package:wallet/ui/settings/settings_list_item.dart';
import 'package:wallet/ui/settings/contacts_widget.dart';
import 'package:wallet/ui/transfer/transfer_overview_sheet.dart';
import 'package:wallet/ui/transfer/transfer_confirm_sheet.dart';
import 'package:wallet/ui/transfer/transfer_complete_sheet.dart';
import 'package:wallet/ui/widgets/dialog.dart';
import 'package:wallet/ui/widgets/security.dart';
import 'package:wallet/ui/widgets/avatar.dart';
...
class _SettingsSheetState extends State<SettingsSheet>
  ...
  ThemeSetting _curThemeSetting = ThemeSetting(ThemeOptions.LIBRA);
              ...
              children: <Widget>[
                ListView(
                  ...
                  children: <Widget>[
                    ...
                    AppSettings.buildSettingsListItemSingleLine(
                        context,
                        AppLocalization.of(context).shareLibra,
                        AppIcons.share, onPressed: () {
                      Share.share(AppLocalization.of(context).shareLibraText +
                          ' https://libra.org');
                    }),
                    Divider(
                      height: 2,
