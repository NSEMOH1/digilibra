...
import 'package:wallet/ui/contacts/contact_details.dart';
...
class _ContactsListState extends State<ContactsList> {
  ...
  Future<void> _exportContacts() async {
    ...
    String filename =
        'libracontacts_${exportTime.year}${exportTime.month}${exportTime.day}${exportTime.hour}${exportTime.minute}${exportTime.second}.txt';
