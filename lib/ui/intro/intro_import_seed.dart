                                ...
                                ? TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      prefixIcon: AnimatedCrossFade(
                                        ...
                                        crossFadeState: Entropy.isValidEntropy(
                                                _seedInputController.text)
                                    ...
                                    onChanged: (text) {
                                      ...
                                      if (Entropy.isValidEntropy(text)) {
                                        _seedInputFocusNode.unfocus();
                                        setState(() {
                                          _seedIsValid = true;
                                        });
                                    ...
                                    onChanged: (text) {
                                      ...
                                      if (Mnemonic.validateMnemonic(text)) {
                                        ...
                                        if (text.endsWith(' ') &&
                                          ...
                                          if (!Mnemonic.isValidWord(lastWord)) {
                                            setState(() {
                                              _mnemonicIsValid = false;
                                              setState(() {
                                                _mnemonicError =
                          ...
                          if (_seedMode) {
                            ...
                            if (Mnemonic.validateMnemonic(
                              ...
                              sl
                                ...
                                sl
                                    .get<Vault>()
                                    .setSeed(Mnemonic.mnemonicListToEntropy(
