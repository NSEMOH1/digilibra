...
class PinScreen extends StatefulWidget {
  ...
  @override
  _PinScreenState createState() => _PinScreenState(type, expectedPin,
      description, pinSuccessCallback, pinScreenBackgroundColor);
}
...
class _PinScreenState extends State<PinScreen>
  ...
  _PinScreenState(this.type, this.expectedPin, this.description,
      this.successCallback, this.pinScreenBackgroundColor);
