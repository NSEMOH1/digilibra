    ...
    switch (type) {
      ...
      case AnimationType.TRANSFER_SEARCHING_QR:
        return Stack(
          children: <Widget>[
            Center(
              child: FlareActor('assets/searchseedqr_animation.flr',
                  animation: 'main', fit: BoxFit.contain),
            )
          ],
        );
      case AnimationType.TRANSFER_SEARCHING_MANUAL:
        return Stack(
          children: <Widget>[
            Center(
              child: FlareActor('assets/searchseedmanual_animation.flr',
                  animation: 'main', fit: BoxFit.contain),
            )
          ],
        );
      case AnimationType.TRANSFER_TRANSFERRING:
        return Stack(
          children: <Widget>[
            ...
            FlareActor(
              'assets/transfer_animation_librawalletonly.flr',
              animation: 'main',
              fit: BoxFit.contain,
